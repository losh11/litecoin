...
static const std::string exodus_testnet = ""; // TODO(losh11): fill these in
//! Regtest Exodus address
static const std::string exodus_regtest = "";
...
{
    const std::string strClassC("6f6d6e69"); // Omni in hex format
    const std::string strClassAB("76a9145c0bc5abc545e8c7387934507bcd20ea0fcb2ff288ac"); // mainnet exodus address scriptPubKey
    const std::string strClassABTest(""); // testnet exodus address scriptPubKey // TODO(losh11): fill this in
...
int mastercore::GetEncodingClass(const CTransaction& tx, int nBlock)
{
    ...
    std::string strClassAB = "76a9145c0bc5abc545e8c7387934507bcd20ea0fcb2ff288ac"; // mainnet exodus scriptPubKey
